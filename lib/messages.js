...
Get recommended position sizing for a given trading pair, risk, and stop-loss.
• \`/peri <Pair> <Direction> <Risk$> <SL%> <TP> <SL>\`

Get recommended position sizing for a given trade margin to use.    
• \`/pvp <Token> <Direction> <#Tokens / $Amount>  <Risk$ Optional>\`

Get recommended position sizing for a given trade margin to use.    
• \`/pvp_pair <Long Token>/<Short Token> <Total Amount $ (+ Leverage)> \`
