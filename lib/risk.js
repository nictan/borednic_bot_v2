...
import { getAssetContextForSymbol, getPerpsByName, getPerpsByName2, getUserPerpMargin } from '../lib/hyper.js';
...
export async function periCalcSimple(fromObj, textMsg) {
...
export async function periCalc2(fromObj, textMsg) {
  ...
  // 3) Fetch perp data for base & quote
  const perpsData = await getPerpsByName2([base, quote]);
